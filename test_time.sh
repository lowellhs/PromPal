...
for i in 1 2 3
do
  time=$(mpirun -n 1 sequential/seq_matvec.o 0 1 | tail -n 1)
  echo "$time" >> $newFile
done
echo >> $newFile
...
for i in 1 2 3
do
  time=$(mpirun -n 1 sequential/seq_matmat.o 0 1 | tail -n 1)
  echo "$time" >> $newFile
done
echo >> $newFile
...
for i in 1 2 3
do
  time=$(mpirun -n $procs point_to_point/mpi_matvec_row.o 0 1 | tail -n 1)
  echo "$time" >> $newFile
done
echo >> $newFile
...
for i in 1 2 3
do
  time=$(mpirun -n $procs point_to_point/mpi_matvec_col.o 0 1 | tail -n 1)
  echo "$time" >> $newFile
done
echo >> $newFile
...
for i in 1 2 3
do
  time=$(mpirun -n $procs point_to_point/mpi_matmat_row.o 0 1 | tail -n 1)
  echo "$time" >> $newFile
done
echo >> $newFile
...
for i in 1 2 3
do
  time=$(mpirun -n $procs collective/mpi_matvec_row.o 0 1 | tail -n 1)
  echo "$time" >> $newFile
done
echo >> $newFile
...
for i in 1 2 3
do
  time=$(mpirun -n $procs collective/mpi_matvec_col.o 0 1 | tail -n 1)
  echo "$time" >> $newFile
done
echo >> $newFile
...
for i in 1 2 3
do
  time=$(mpirun -n $procs collective/mpi_matmat_row.o 0 1 | tail -n 1)
  echo "$time" >> $newFile
done